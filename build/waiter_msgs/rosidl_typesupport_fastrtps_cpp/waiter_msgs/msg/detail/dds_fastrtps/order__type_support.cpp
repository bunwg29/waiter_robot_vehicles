...
#include "waiter_msgs/msg/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = waiter_msgs::msg::Order;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const waiter_msgs::msg::Order *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<waiter_msgs::msg::Order *>(
    untyped_ros_message);
...
{
  return &waiter_msgs::msg::typesupport_fastrtps_cpp::_Order__handle;
}
