...
bool waiter_msgs__msg__order__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("waiter_msgs.msg._order.Order", full_classname_dest, 28) == 0);
  }
  waiter_msgs__msg__Order * ros_message = _ros_message;
  {  // table_id
...
PyObject * waiter_msgs__msg__order__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("waiter_msgs.msg._order");
